...
# nodal masses:
mass 1 0 1683.18 0.;			   # node XD DY RZ (Mass=Weight in kg)
mass 2 0 11488.82 0.;               # Mass in the Y-direction is needed for gravity loads
...
section Elastic 1 {{{:E}}} 0.007 0.66  
section Elastic 2 {{{:E}}} 0.015 4.07
